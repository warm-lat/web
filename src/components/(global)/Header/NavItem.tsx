...
const NavItem: React.FC<NavItemProps> = ({ label, destination, isActive }) => {
								...
								>
									<div>
										...
										<p className="text-sm text-zinc-400">
											Advanced auto-moderation system with customizable filters,
											anti-spam, and content detection
										</p>
									</div>
								...
								<div className="grid grid-cols-2 gap-4">
									...
									>
										<div className="flex items-center gap-3 mb-1">
											...
											<div className="font-medium text-white">Music Player</div>
										</div>
										<p className="text-sm text-zinc-400">
	...
	return (
		<Link
			href={destination}
			className={`font-medium text-[#71767C] hover:text-[#8B8F95]`}
		>
			{label}
		</Link>
	);
