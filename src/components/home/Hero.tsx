...
const Hero = ({ stats }: { stats: { users: number; guilds: number } }) => {
	return (
		<div className="relative flex items-center justify-center mt-16 mb-12">
				...
				>
					...
					>
						<motion.div
							...
							className="relative w-36 h-36 md:w-48 md:h-48 rounded-3xl overflow-hidden drop-shadow-2xl ring-1 ring-white/6 bg-gradient-to-br from-white/3 to-transparent"
						>
							<Image
