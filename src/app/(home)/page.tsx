								...
								>
									...
									>
										...
										<p className="mt-8 text-lg md:text-xl text-white/50 max-w-2xl leading-relaxed">
											...
											users
											<br className="hidden sm:block" /> with advanced
											moderation, music, and utility features.
										</p>
								...
								>
									<div className="relative z-10">
										...
										<div className="grid grid-cols-2 gap-2 mt-4">
											{["/help", "/play", "/ban", "/settings"].map((cmd, i) => (
												<motion.div
													key={i}
													initial={{ opacity: 0 }}
													whileInView={{ opacity: 1 }}
										...
										<div className="grid md:grid-cols-2 gap-8">
											<div className="space-y-4">
												<p className="text-white/60 leading-relaxed">
													Create engaging giveaways with custom requirements,
													multiple winners, and bonus entries
												</p>
												...
												<div className="bg-black/20 rounded-lg p-4 font-mono text-sm">
													...
													>
														...
														<span className="text-green-400"> Nitro</span>
											...
											<div className="space-y-6">
												<div className="bg-black/20 rounded-lg p-4 font-mono text-sm">
													<div className="text-white/80">
														,starboard add{" "}
														<span className="text-yellow-400">#skullboard</span>{" "}
														💀{" "}
														<span className="text-purple-400">
															--threshold 3
														</span>{" "}
														<span className="text-green-400">--self_star</span>
													</div>
												</div>
												...
												<div className="grid grid-cols-2 gap-2">
													{[
														...
														["Adjustable threshold", "Self-star option"],
													...
													<div className="bg-black/40 rounded-lg p-4">
														<div className="flex items-start gap-3">
															...
															<div className="flex-1">
																<div className="flex items-center gap-2">
																	<span className="text-white">lucvmf</span>
																	<span className="text-white/40 text-xs">
																		Today at 17:26
																	</span>
																</div>
																<p className="text-white/80 text-sm mt-1">
																	its a man hanging sideways on a strip pole
																</p>
															</div>
														</div>
													</div>
													<div className="text-white/40 text-sm text-center">
														Messages with 3+ 💀 reactions will appear here
													</div>
												</div>
											</div>
										</div>
										...
										<div className="relative z-10">
											...
											<div className="bg-black/40 rounded-lg p-4 mb-4">
												<div className="flex items-center gap-2 mb-3">
													...
													<div>
														<div className="flex items-center gap-2">
															<span className="text-white text-sm">lucvmf</span>
															<span className="text-white/40 text-xs">
																used
															</span>
									...
									<div className="relative z-10">
										...
										<div className="bg-[#18191c] rounded-lg p-4">
											...
											<div className="mb-2">
												...
												<div className="flex items-center gap-2">
													<span className="text-white/60 text-xs">01:30</span>
													<div className="flex-1 h-[3px] bg-white/10 rounded-full">
														<div className="w-1/3 h-full bg-white rounded-full" />
													</div>
													<span className="text-white/60 text-xs">04:26</span>
												</div>
											</div>
									...
									<div className="relative z-10">
										...
										<div className="grid md:grid-cols-2 gap-6">
											<div>
												...
												<p className="text-white/60 text-sm mb-4">
													Access your ticket history with our aesthetic and
											...
											<div>
												...
												<p className="text-white/60 text-sm mb-4">
													Track server activity and engagement with beautiful
													web leaderboards
												</p>
												<div className="bg-black/40 rounded-lg p-4">
													<div className="space-y-3">
														<div className="flex items-center gap-3 bg-white/[0.02] rounded-lg p-3">
															...
															<div className="flex-1">
																<div className="text-white text-sm">_mism.</div>
																<div className="text-white/40 text-xs">
																	Level 75 • 43,000 XP
																</div>
															</div>
														...
														<div className="flex items-center gap-3 bg-white/[0.02] rounded-lg p-3">
															...
															<div className="flex-1">
																<div className="text-white text-sm">warm</div>
																<div className="text-white/40 text-xs">
																	Level 50 • 35,000 XP
																</div>
															</div>
									...
									>
										<div className="relative z-10">
											<div className="mb-4">
												...
												<div className="text-sm text-white/40">Commands</div>
											</div>
										</div>
										<div
											className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent 
