    ...
    const content = (() => {
        ...
        return (
            <div className="max-w-[1920px] mx-auto space-y-6 md:space-y-8">
                ...
                <div className="flex gap-2 p-1 bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-xl w-fit overflow-x-auto">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6">
                    <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8">
                        <h3 className="text-base md:text-lg font-semibold text-white mb-6">Activity Trends</h3>
                    ...
                    <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8">
                        <h3 className="text-base md:text-lg font-semibold text-white mb-6">Moderation Actions</h3>
                        <div className="h-[250px] md:h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8">
                    <h3 className="text-base md:text-lg font-semibold text-white mb-6">Moderation Breakdown</h3>
    ...
    return (
        <div className="relative group">
            ...
            <div className="relative bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all">
                ...
                <div>
                    <div className="text-2xl md:text-3xl font-bold text-white mb-1">{value.toLocaleString()}</div>
