					...
					<div className="mt-6 space-y-6">
							...
							<div className="flex-1">
								...
								<div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-4">
									<div className="flex items-center gap-2 text-white/60">
										...
										<span>
											{settings.guild.member_count.toLocaleString()} members
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/60">
									...
									<div className="flex items-center gap-2 text-white/60">
										...
										<span>
											Created:{" "}
											{format(
												new Date(settings.guild.created_at),
												"MMM d, yyyy"
											)}
										</span>
									</div>
							...
							<div className="bg-black/20 rounded-lg p-4">
								...
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											SafeSearch: {settings.settings.safesearch_level}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										<Check className="w-4 h-4" />
										<span>
											Transcription:{" "}
											{settings.settings.transcription ? "Enabled" : "Disabled"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										<Check className="w-4 h-4" />
										<span>
											Welcome Removal:{" "}
											{settings.settings.welcome_removal
												? "Enabled"
												: "Disabled"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Reskin:{" "}
											{settings.settings.reskin ? "Enabled" : "Disabled"}
										</span>
									</div>
								</div>
							</div>
							...
							<div className="bg-black/20 rounded-lg p-4">
								...
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Prefix:{" "}
											{settings.settings.reposter.prefix
												? "Enabled"
												: "Disabled"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Delete:{" "}
											{settings.settings.reposter.delete
												? "Enabled"
												: "Disabled"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Embed:{" "}
											{settings.settings.reposter.embed
												? "Enabled"
												: "Disabled"}
										</span>
									</div>
							...
							<div className="bg-black/20 rounded-lg p-4">
								...
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Channel:{" "}
											{settings.settings.verification.channel_id || "Not Set"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										<Check className="w-4 h-4" />
										<span>
											Role:{" "}
											{settings.settings.verification.role_id || "Not Set"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										<Check className="w-4 h-4" />
										<span>
											VPN Check:{" "}
											{settings.settings.verification.vpn_check
												? "Enabled"
												: "Disabled"}
										</span>
									</div>
							...
							<div className="bg-black/20 rounded-lg p-4">
								...
								<div className="space-y-2">
									<div className="flex items-center gap-2 text-white/80">
										...
										<span>
											Panel:{" "}
											{settings.settings.play.panel ? "Enabled" : "Disabled"}
										</span>
									</div>
									<div className="flex items-center gap-2 text-white/80">
										<Check className="w-4 h-4" />
										<span>
											Deletion:{" "}
											{settings.settings.play.deletion ? "Enabled" : "Disabled"}
										</span>
									</div>
								</div>
							</div>
						...
						<div className="bg-black/20 rounded-lg overflow-hidden">
							...
							{settings?.recent_commands &&
								settings.recent_commands.length > 0 && (
										...
										<div>
											<p className="text-sm text-white/60 text-center sm:text-left">
												...
												<span className="font-medium text-white">
													{Math.min(
														currentPage * itemsPerPage,
														settings.recent_commands.length
													)}
												</span>{" "}
												of{" "}
												<span className="font-medium text-white">
