						...
						src={
							presenceData.discord_user.avatar
								? `https://cdn.discordapp.com/avatars/${
										...
										presenceData.discord_user.avatar.startsWith("a_")
											? "gif"
											: "png"
								  }?size=128`
						...
						{[
							...
							return (
								<img
									key={i}
									src={`/badges/${
										BADGE_MAPPING[normalizedBadge] || normalizedBadge
									}.png`}
									alt={badge}
									className={`${
		...
		fetch(`https://api.warm.lat/users/presence`, { headers })
			...
			.then((data: ApiResponse) => {
				const uniqueUsers = data.data.filter(
					(user, index, self) =>
						index ===
						self.findIndex((u) => u.discord_user.id === user.discord_user.id)
				);
			...
			<div className="mt-16">
				<div className="text-center mb-8">
					...
					<p className="mt-2 text-zinc-400">
						The core development team behind Warm
					</p>
				</div>
										...
										src={
											user.discord_user.avatar
												? `https://cdn.discordapp.com/avatars/${
														...
														user.discord_user.avatar.startsWith("a_")
															? "gif"
															: "png"
												  }?size=128`
