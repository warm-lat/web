	...
	return (
		<div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
			...
			<span className="text-neutral-400 text-sm mt-5">
				...
				you are refunded under any circumstances, your Discord account may be
			...
			<span className="text-neutral-400 text-sm mt-5">
				...
				liability for any reason (including, but not limited to, a breach of the
				terms).
			</span>
			<span className="font-bold text-2xl text-white pt-10">Indemnity</span>
			<span className="text-neutral-400 text-sm mt-5">
				You shall indemnify us against all liabilities, costs, expenses, damages
				...
				by you arising out of or in connection with your use of the service, or
			...
			<span className="text-neutral-400 text-sm mt-5">
				We reserve the right to revoke access to biolinks or all our services at
			...
			<span className="text-neutral-400 text-sm mt-5">
				Violations of these terms or our privacy policy may result in an
				immediate and permanent ban across all our services. We maintain zero
				tolerance for abuse of our biolinks service.
			</span>
		</div>
	);
};
