	...
	return (
		<div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
			...
			<span className="text-neutral-400 text-sm mt-5">
				When a command is invoked, we store the message content for a maximum of
				14 days for debugging purposes. We also store a maximum of 18 entries
				for edited messages and sniping messages that will expire in two hours
				or less in volatile memory.
			</span>
			<span className="text-neutral-400 text-sm mt-5">
			...
			<span className="text-neutral-400 text-sm mt-5">
				...
				&quot;namehistory&quot; and &quot;avatarhistory&quot; commands to
				function. Users can clear this data themselves at any time.
			</span>
			<span className="text-neutral-400 text-sm mt-5">
			...
			<span className="text-neutral-400 text-sm mt-5">
				Email <span className="text-white font-semibold">support@warm.lat</span>{" "}
				for all of your data that we are currently storing. Response times may
				vary and could take up to 7 days.
			</span>
			<span className="font-bold text-2xl text-white pt-10">
			...
			<span className="text-neutral-400 text-sm mt-5">
				...
				disaster recovery, we maintain replicated backups across data centers in
				New York, USA and Falkenstein, Germany.
			</span>
			<span className="text-neutral-400 text-sm mt-5">
				We perform automated backups every 8 hours (3 times daily) in UTC
				timezone. These backups are retained for 7 days before being permanently
				deleted. While we will honor data deletion requests for our active
				systems, please note that we may be unable to remove your data from
			...
			<span className="text-neutral-400 text-sm mt-5">
				We can update these terms at any time without notice. Continuing to use
				our services after any changes will mean that you agree with these terms
				and violation of our terms of service could result in a permanent ban
