		...
		<>
			<div className={`${clash.variable} relative w-full`}>
					...
					<div className="relative max-w-7xl mx-auto px-4 pt-32">
						<div className="text-center max-w-5xl mx-auto">
							...
							<div className="space-y-4 mb-12">
								...
								<p className="text-xl md:text-2xl text-white/60">
									This is where Warm Premium comes into play.
								</p>
							</div>
							<a
								href="#plans"
					...
					<div className="grid md:grid-cols-3 gap-8 mb-24">
						{[
							...
							},
							{
								...
								description:
									"System access limited to Warm administrators and senior staff.",
							},
						].map((feature, i) => (
				...
				<div className="mt-32 mb-24 max-w-7xl mx-auto px-4">
					<h2
						className="font-clash font-bold text-4xl text-center mb-4"
						id="plans"
					>
						All of our Plans
					</h2>
					<p className="text-white/60 text-center mb-16">
						Check out Warm&apos;s Premium plans and instance offering
					</p>
							...
							<div className="border-t border-white/10 pt-4">
								...
								<div className="space-y-2 text-sm text-white/60">
									<p className="flex items-center gap-2">
										...
										bc1qhnknyzmpanu8h9d74342ycn7fsf90c630ymsny
									</p>
									<p className="flex items-center gap-2">
										<FaEthereum className="text-[#627EEA]" /> ETH:
										0xAed59a2bcD8D163f7bAC0846C23bC382C5A80C56
									</p>
									<p className="flex items-center gap-2">
										<SiXrp /> XRP: rfT2Gb2yTrC3tHQ6n3gRMt16i5i28EEvAK
									</p>
									<p className="flex items-center gap-2">
					...
					<Dialog.Panel className="bg-[#0B0C0C] rounded-2xl p-6 max-w-md w-full">
						...
						<div className="space-y-4">
							...
							<p className="text-sm text-white/60">
								Note: Stripe payments are automated. Crypto payments require
								manual verification through support.
							</p>
						</div>
					</Dialog.Panel>
				</div>
