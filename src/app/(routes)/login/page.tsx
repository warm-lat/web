				...
				{!session ? (
					...
					<>
						<div className="text-center">
							...
							<p className="mt-2 text-sm text-zinc-400">
								You&apos;re signed in with Discord. Connect your {"Last.fm"}{" "}
								account to continue.
							</p>
						</div>
						...
						<div className="mt-8">
							<button
								onClick={() => handleSignIn("lastfm")}
								className={`flex w-full items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold text-white transition-all ${"bg-[#d51007] hover:bg-[#b30d06] focus:ring-2 focus:ring-[#d51007] focus:ring-offset-2 focus:ring-offset-zinc-900"}`}
							>
								<FaLastfm className="h-5 w-5" />
								Connect {"Last.fm"}
							</button>
