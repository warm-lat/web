			...
			<div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center">
				<div className="text-center">
					...
					<p className="text-white/60 max-w-md mx-auto">
						Thank you for your interest in joining our team. We&apos;sll review
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[3.5rem]">
					<div className="max-w-3xl">
						...
						<p className="text-xl text-gray-400 leading-relaxed">
							Join Warm&apos;s team of innovators and help create the next
							generation of Discord moderation tools. Whether you&apos;re a
							community expert or a tech enthusiast, there&apos;s a place for
							you here.
						</p>
					</div>
				</div>
					...
					<div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
						<div className="flex-1">
							...
							<p className="text-lg text-gray-300 mb-6">
								...
								help shape the future of Warm. We&apos;re looking for
								enthusiastic community members to join our beta testing program.
							</p>
				...
				<div className="flex flex-col md:flex-row items-center justify-between gap-8">
					<div className="flex-1">
						...
						<p className="text-lg text-gray-300 mb-6">
							...
							innovators who are shaping the future of Discord moderation. Get
							to know the faces behind Warm and see where you might fit in.
						</p>
						<button
					...
					<div className="max-w-7xl mx-auto space-y-12">
						...
						<div>
							...
							<p className="text-zinc-400">
								{selectedRoleData?.timeCommitment}
							</p>
						</div>
										...
										<div className="flex items-start">
											...
											<div className="ml-3">
												...
												<div className="mt-1 text-sm text-amber-300/80">
													...
													submitting. You can only apply once for each role, and
													applications cannot be modified after submission. Make
													sure to provide detailed and thoughtful responses that
